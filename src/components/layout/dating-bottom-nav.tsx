...
export function DatingBottomNav() {
  ...
  return (
    <nav
      ...
      className="pointer-events-none relative z-50 w-full shrink-0 px-2.5 pb-[max(.55rem,env(safe-area-inset-bottom))] pt-2"
    >
      <div className="pointer-events-auto relative mx-auto flex h-[68px] w-full max-w-[36rem] items-center overflow-hidden rounded-[24px] border border-white/[.08] bg-[#09090c]/92 px-1.5 shadow-[0_-10px_36px_rgba(0,0,0,.28),0_18px_44px_rgba(0,0,0,.42)] backdrop-blur-2xl">
