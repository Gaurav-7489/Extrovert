...
export default async function AppLayout({children}:{children:React.ReactNode}){
 ...
 return <div className="flex h-[100dvh] w-full flex-col overflow-hidden bg-white overscroll-none text-zinc-950 dark:bg-[#0a0a0a] dark:text-zinc-100"><AppNavbar userEmail={userEmail} isSuperAdmin={isSuperAdmin}/><main className="min-h-0 flex-1 overflow-y-auto pb-[76px]">{children}</main><DatingBottomNav/><LazyGlobalFeatures/><MessageKeyBootstrap userId={userId}/></div>;
}
